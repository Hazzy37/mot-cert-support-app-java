...
function parseFilesAndGenerateReport(files) {
  ...
  for (const file of files) {
    ...
    if (new Date(content.startTime) < new Date(json.startTime)) json.startTime = content.startTime;
    ...
    for (const fixture of content.fixtures) {
      ...
      if (theSameFix) theSameFix.tests.push(...fixture.tests);else json.fixtures.push(fixture);
    }
  }
